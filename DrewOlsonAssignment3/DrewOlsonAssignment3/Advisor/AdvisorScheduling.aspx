<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdvisorScheduling.aspx.cs" Inherits="DrewOlsonAssignment3.Advisor.AdvisorScheduling" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        ...
        <asp:SqlDataSource ID="AppointmentSourceStudent" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [AppointmentTable] WHERE ([AdvisorUserName] = @AdvisorUserName)">
            <SelectParameters>
                <asp:SessionParameter Name="AdvisorUserName" SessionField="UserName" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
    ...
    <p>
        <asp:TextBox ID="TextBox1" runat="server" CssClass="auto-style4" Width="46px" OnTextChanged="TextBox1_TextChanged">00</asp:TextBox>
&nbsp;:&nbsp;
